...
const About: React.FC<IAboutProps> = inject("aboutStores")(
	observer(
		({ aboutStores }): React.ReactElement => {
			const about: IAbout = aboutStores!.getAboutInfo
			...
			return (
				<>
					...
					<div className='wrapper'>
						<section className='slogan'>{about.why!}</section>
					</div>
					...
					{openSlide && (
						<section id='how_we_work_form'>
							...
							<div className='how_we_work_wrapper'>
								<img
									src='/img/prev_slide_blue.png'
									alt='prev'
									id='prev_slide'
								/>
								<img
									src='/img/next_slide_blue.png'
									alt='next'
									id='next_slide'
								/>
