...
interface ISiteTypeProps {
	sitetypeStores: SiteTypeStores
}
const SiteType: React.FC<ISiteTypeProps> = inject("sitetypeStores")(
	observer(
		({ sitetypeStores }): React.ReactElement => {
			const types: ISiteType[] = sitetypeStores!.getSiteTypeInfo
										...
										<Collapse.Panel
											...
											header={
												<div
													...
													<img src={item.icon} alt='' className='type_icon' />
													<p>{item.title}</p>
												</div>
											}
											key={index + 1}>
							...
							<div id='type_description_container'>
								{typeSite && (
									<div
										...
										<div className='description'>
											<div
												dangerouslySetInnerHTML={{ __html: typeSite.desc! }}
											/>
										</div>
										<div className='images'>
